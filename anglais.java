...
public class anglais {
    ...
    public static void main(String[] args) {
        ...
        if("yes".equals(finalconfirmation) ||"no".equals(finalconfirmation)){
            System.out.println("I gave the chance earlier to not take the quiz/survey,"+name+"......\uD83D\uDE11\uD83D\uDE11" +
                    "\nBut NOPE! You decided to take my survey/quiz." +
                    "\nSo guess what" +
                    "\nWe gonna finish it\uD83D\uDE08\uD83D\uDE08");
        }
        ...
        int fin = score;
        System.out.println("Final score:"+ (fin) +"/28");
